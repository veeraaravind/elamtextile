...
{
    public static $leftBabeen = 1;
    public static $rightBabeen = 2;
    /**
     * {@inheritdoc}
     */
    ...
    public static function getBabeenProviderInventoryList()
    {
        return [
            1 => Yii::t('app', 'Left Babeen'),
            2 => Yii::t('app', 'Right Babeen')
        ];
    }
}
