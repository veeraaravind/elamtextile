            ...
            <?php if (count($mapWarpWeaverInventoryData['all_inventory_records']) > 0): ?>
                <?php foreach ($mapWarpWeaverInventoryData['all_inventory_records'] as $eachRecord): ?>
                    <tr>
                        ...
                        <td>
                            <a href="javascript:;" class="viewWarpWeaverInventory" title="View" data-id="<?php echo $eachRecord['id']; ?>" data-model="<?php echo 'MapWarpWeaverInventory'; ?>"><i class="fa fa-eye"></i></a> 
                            <?php if (!$isWarpFinished): ?>
                                <a href="javascript:;" class="updateWarpWeaverInventory" title="Update" data-id="<?php echo $eachRecord['id']; ?>" data-model="<?php echo 'MapWarpWeaverInventory'; ?>"><i class="fa fa-pencil-alt"></i></a> 
                                <a href="javascript:;" class="deleteWarpWeaverInventory" title="Delete" data-id="<?php echo $eachRecord['id']; ?>" data-model="<?php echo 'MapWarpWeaverInventory'; ?>"><i class="fa fa-trash-alt"></i></a>
                            <?php endif; ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
