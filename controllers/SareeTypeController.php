...
class SareeTypeController extends BaseController
{
    ...
    public function actionView($id)
    {
        ...
        if ($data) {
            $data['foreign_value_pettu_type'] = (new SareeType)->getPettuType()[$data['pettu_type']];
        }
        return json_encode(
            [
                'data' => $data,
                'displayFields' => ['name', 'pettu_type', 'yarn_weight', 'jarigai_weight', 'babeen_meter', 'out_weaver_fee', 'in_weaver_fee'],
